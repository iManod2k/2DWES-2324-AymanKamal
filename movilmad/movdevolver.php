<?php
	...
	require ("views/view_devolver.php");
?>
<html>
  ...
  <body>
	...
	<form action="controllers/contr_devolver.php" method="post">
	
		<B>Bienvenido/a: <?php echo $_SESSION['info_user']['nombre']?></B>  <BR><BR>
		<B>Identificador Cliente: <?php echo $_SESSION['info_user']['idcliente']?></B>  <BR><BR>
